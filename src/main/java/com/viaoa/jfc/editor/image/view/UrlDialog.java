...
public class UrlDialog extends JDialog {
    ...
    public UrlDialog(Window parent) {
        super(parent, "Download image from web", ModalityType.APPLICATION_MODAL);
    ...
    protected JPanel getPanel() {
        ...
        pan.add(new JLabel("Image URL from Web Page:"), gc);
