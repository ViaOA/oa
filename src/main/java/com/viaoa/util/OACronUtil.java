...
/**
 * Used to find the next time a Cron-like entry should be ran.
...
public class OACronUtil {
    ...
    public OACronUtil(String strMins, String strHours, String strDayOfMonth, String strMonth, String strDayOfWeek) {
