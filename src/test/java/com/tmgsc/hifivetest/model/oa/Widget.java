...
public class Widget extends OAObject {
    ...
    @OAProperty(maxLength = 175, displayLength = 40)
    ...
    public void setLink(String newValue) {
        fireBeforePropertyChange(P_Link, this.link, newValue);
        String old = link;
        this.link = newValue;
    ...
    @OAMany(
        ...
        reverseName = Program.P_Widgets
    )
    @OALinkTable(name = "ProgramWidget", indexName = "ProgramWidget", columns = {"WidgetId"})
