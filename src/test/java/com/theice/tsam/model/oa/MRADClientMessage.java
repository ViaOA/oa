...
public class MRADClientMessage extends OAObject {
    ...
    private static Logger LOG = Logger.getLogger(MRADClientMessage.class.getName());
    ...
    @OAProperty(maxLength = 254, displayLength = 20, columnLength = 18)
    ...
    @OAProperty(displayLength = 4, isNameValue = true)
    @OAColumn(sqlType = java.sql.Types.INTEGER)
    public int getType() {
        return type;
    }
