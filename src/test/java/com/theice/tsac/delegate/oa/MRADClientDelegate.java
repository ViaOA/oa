...
import com.theice.tsac.model.oa.ApplicationStatus;
...
import com.theice.tsac.model.oa.MRADServer;
import com.theice.tsac.model.oa.OSVersion;
import com.theice.tsac.model.oa.OperatingSystem;
...
public class MRADClientDelegate {
    ...
    public static MRADClient getMRADClient(MRADServer mradServer, com.theice.tsac.mrad.model.Application clientApp) {
        try {
            lock.lock();
    ...
    private static MRADClient _getMRADClient(MRADServer mradServer, com.theice.tsac.mrad.model.Application clientApp) {
        ...
        com.theice.tsac.mrad.model.Server clientServer = clientApp.getServer();
        if (clientServer == null) return null;
        
        com.theice.tsac.mrad.model.ApplicationType clientAppType = clientApp.getApplicationType();
        if (clientAppType == null) return null;
        
        com.theice.tsac.mrad.model.SiloType clientSiloType = clientServer.getSiloType();
    ...
    public static boolean update(MRADClient mradClient, com.theice.tsac.mrad.model.Application clientApplication) {
        if (mradClient == null || clientApplication == null) return false;
        
        com.theice.tsac.mrad.model.Server clientServer = clientApplication.getServer();
        ...
        com.theice.tsac.mrad.model.ApplicationType clientApplicationType = clientApplication.getApplicationType();
        ...
        com.theice.tsac.mrad.model.ApplicationStatus clientAppStatus = clientApplication.getApplicationStatus();
