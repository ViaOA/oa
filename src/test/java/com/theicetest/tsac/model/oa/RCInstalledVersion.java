...
import com.theicetest.tsac.delegate.oa.RCInstalledVersionDelegate;
import com.theicetest.tsac.delegate.oa.RemoteClientDelegate;
...
public class RCInstalledVersion extends OAObject {
    ...
    @OAOne(
        ...
        isCalculated = true, 
        reverseName = RemoteClient.P_RCInstalledVersions, 
        allowCreateNew = false
    )
    ...
    public void run() throws Exception {
        RCInstalledVersionDelegate.run(this);
    }
     
    // process - Processing RC server installed versions
    public void process() throws Exception {
        RCInstalledVersionDelegate.process(this);
    }
     
    // load - Load into database
    public void load() throws Exception {
        RCInstalledVersionDelegate.load(this);
    }
