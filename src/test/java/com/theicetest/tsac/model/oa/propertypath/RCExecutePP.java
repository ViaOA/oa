...
public class RCExecutePP {
    ...
    private static RCDownloadPPx rcDownloads;
    private static RCInstalledVersionPPx rcInstalledVersions;
    private static RCInstallPPx rcInstalls;
    ...
    private static RCStagePPx rcStages;
    private static RCStartPPx rcStarts;
    private static RCStopPPx rcStops;
    private static RCVerifyPPx rcVerifies;
    ...
    public static RCDownloadPPx rcDownloads() {
        if (rcDownloads == null) rcDownloads = new RCDownloadPPx(RCExecute.P_RCDownloads);
        return rcDownloads;
    }
    ...
    public static RCInstallPPx rcInstalls() {
        if (rcInstalls == null) rcInstalls = new RCInstallPPx(RCExecute.P_RCInstalls);
        return rcInstalls;
    }
    ...
    public static RCStagePPx rcStages() {
        if (rcStages == null) rcStages = new RCStagePPx(RCExecute.P_RCStages);
        return rcStages;
    }

    public static RCStartPPx rcStarts() {
        if (rcStarts == null) rcStarts = new RCStartPPx(RCExecute.P_RCStarts);
        return rcStarts;
    }

    public static RCStopPPx rcStops() {
        if (rcStops == null) rcStops = new RCStopPPx(RCExecute.P_RCStops);
        return rcStops;
    }

    public static RCVerifyPPx rcVerifies() {
        if (rcVerifies == null) rcVerifies = new RCVerifyPPx(RCExecute.P_RCVerifies);
        return rcVerifies;
    }
