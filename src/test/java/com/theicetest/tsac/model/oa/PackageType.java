...
public class PackageType extends OAObject {
    ...
    @OAProperty(maxLength = 14, isUnique = true, displayLength = 14, columnLength = 12)
    ...
    @OAProperty(displayName = "Package Name", description = "solaris package name, ex: ICEgsmr", maxLength = 55, displayLength = 40, columnLength = 12, isProcessed = true)
    ...
    */
    ...
    @OAMany(
        ...
        reverseName = RCVerifyDetail.P_PackageType, 
        createMethod = false
    )
