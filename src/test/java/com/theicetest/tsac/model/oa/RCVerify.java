...
import com.theicetest.tsac.delegate.ServerModelDelegate;
import com.theicetest.tsac.delegate.oa.*;
...
@OATable(
    indexes = {
        @OAIndex(name = "RCVerifyRcDeploy", columns = { @OAIndexColumn(name = "RcDeployId") })
    }
)
public class RCVerify extends OAObject {
    ...
    protected transient Hub<RCVerifyDetail> hubRCVerifyDetails;
    ...
    @OAOne(
        ...
        reverseName = RCDeploy.P_RCVerify
    )
    ...
    @OAOne(
        ...
        reverseName = RCExecute.P_RCVerifies
    )
    ...
    @OAMany(
        ...
        reverseName = RCVerifyDetail.P_RCVerify
    )
    public Hub<RCVerifyDetail> getRCVerifyDetails() {
        if (hubRCVerifyDetails == null) {
            hubRCVerifyDetails = (Hub<RCVerifyDetail>) getHub(P_RCVerifyDetails);
        }
        return hubRCVerifyDetails;
    }
    
    // run
    public void run() throws Exception {
        RCVerifyDelegate.run(this);
    }
     
    // process
    public void process() throws Exception {
        RCVerifyDelegate.process(this);
    }
