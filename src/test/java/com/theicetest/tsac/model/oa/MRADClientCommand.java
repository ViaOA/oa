...
public class MRADClientCommand extends OAObject {
    ...
    @OAProperty(displayName = "Status date/time", defaultValue = "new OADateTime()", displayLength = 15, isProcessed = true)
    ...
    @OAProperty(maxLength = 175, displayLength = 40, columnLength = 12, isProcessed = true)
