...
public class RemoteClientPPx implements PPxInterface, Serializable {
    ...
    public MRADServerPPx mradServers() {
        MRADServerPPx ppx = new MRADServerPPx(this, RemoteClient.P_MRADServers);
        return ppx;
    }
    ...
    public String dtStatus() {
        return pp + "." + RemoteClient.P_DtStatus;
    }

    public String autoStart() {
        return pp + "." + RemoteClient.P_AutoStart;
    }

    public String console() {
        return pp + "." + RemoteClient.P_Console;
    }
