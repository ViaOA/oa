...
import com.theicetest.tsac.delegate.oa.RCServiceListDelegate;
...
public class RCServiceList extends OAObject {
    ...
    public void run() throws Exception {
        RCServiceListDelegate.run(this);
    }
     
    // process - Processing RC service listing
    public void process() throws Exception {
        RCServiceListDelegate.process(this);
    }
     
    // load - Load into database
    public void load() throws Exception {
        RCServiceListDelegate.load(this);
    }
