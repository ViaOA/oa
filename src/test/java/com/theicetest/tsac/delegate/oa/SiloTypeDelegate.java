...
public class SiloTypeDelegate {
    ...
    public static SiloType getSiloType(com.theicetest.tsac.mrad.model.SiloType clientSiloType) {
        int type = SiloType.TYPE_ICE;
        if (clientSiloType != null) {
            if (clientSiloType == com.theicetest.tsac.mrad.model.SiloType.Endex) type = SiloType.TYPE_Endex;
            else if (clientSiloType == com.theicetest.tsac.mrad.model.SiloType.Liffe) type = SiloType.TYPE_Liffe;
        }
