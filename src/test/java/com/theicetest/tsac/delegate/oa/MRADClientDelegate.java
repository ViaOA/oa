...
import com.theicetest.tsac.model.oa.Application;
import com.theicetest.tsac.model.oa.ApplicationStatus;
import com.theicetest.tsac.model.oa.ApplicationType;
import com.theicetest.tsac.model.oa.Environment;
import com.theicetest.tsac.model.oa.MRADClient;
import com.theicetest.tsac.model.oa.MRADServer;
import com.theicetest.tsac.model.oa.OSVersion;
import com.theicetest.tsac.model.oa.OperatingSystem;
import com.theicetest.tsac.model.oa.Server;
import com.theicetest.tsac.model.oa.Silo;
import com.theicetest.tsac.model.oa.SiloType;
...
public class MRADClientDelegate {
    ...
    public static MRADClient getMRADClient(MRADServer mradServer, com.theicetest.tsac.mrad.model.Application clientApp) {
        try {
            lock.lock();
    ...
    private static MRADClient _getMRADClient(MRADServer mradServer, com.theicetest.tsac.mrad.model.Application clientApp) {
        ...
        com.theicetest.tsac.mrad.model.Server clientServer = clientApp.getServer();
        if (clientServer == null) return null;
        
        com.theicetest.tsac.mrad.model.ApplicationType clientAppType = clientApp.getApplicationType();
        if (clientAppType == null) return null;
        
        com.theicetest.tsac.mrad.model.SiloType clientSiloType = clientServer.getSiloType();
    ...
    public static boolean update(MRADClient mradClient, com.theicetest.tsac.mrad.model.Application clientApplication) {
        if (mradClient == null || clientApplication == null) return false;
        
        com.theicetest.tsac.mrad.model.Server clientServer = clientApplication.getServer();
        ...
        com.theicetest.tsac.mrad.model.ApplicationType clientApplicationType = clientApplication.getApplicationType();
        ...
        com.theicetest.tsac.mrad.model.ApplicationStatus clientAppStatus = clientApplication.getApplicationStatus();
