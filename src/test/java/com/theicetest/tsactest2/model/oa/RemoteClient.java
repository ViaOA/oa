...
import com.theicetest.tsactest2.model.oa.filter.*;
...
public class RemoteClient extends OAObject {
    ...
    public static final String PROPERTY_AdminServers = "AdminServers";
    public static final String P_AdminServers = "AdminServers";
    ...
    public static final int TYPE_AS = 4;
    ...
    protected transient Hub<AdminServer> hubAdminServers;
    ...
    @OAMany(
        displayName = "Admin Servers", 
        toClass = AdminServer.class, 
        isCalculated = true, 
        reverseName = AdminServer.P_RemoteClient
    )
    public Hub<AdminServer> getAdminServers() {
        if (hubAdminServers != null) return hubAdminServers;
        hubAdminServers = (Hub<AdminServer>) getHub(P_AdminServers);
        return hubAdminServers;
    }
    @OAMany(
