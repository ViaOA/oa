...
public class Timezone extends OAObject {
    ...
    @OAProperty(maxLength = 55, displayLength = 30, columnLength = 24, isProcessed = true)
    ...
    @OAProperty(displayName = "UTC Offset", description = "amount of hours between a timezone and UTC timezone", displayLength = 5, isProcessed = true)
    @OAColumn(sqlType = java.sql.Types.INTEGER)
    /**
    ...
    */
    ...
    @OACalculatedProperty(displayName = "Display Name", displayLength = 22, columnLength = 18, properties = {P_Name, P_UTCOffset})
