...
package com.theicetest.tsactest2.model.oa.cs;
...
public class ServerRoot extends OAObject {
    ...
    public Hub<Company> getCompanies() {
        if (hubCompanies == null) {
            ...
            String cpp = OAString.cpp(Site.P_Environments, Environment.P_Companies);
            HubMerger hm = new HubMerger(this.getSites(), hubCompanies, cpp, false, true);
        }
        return hubCompanies;
    }
