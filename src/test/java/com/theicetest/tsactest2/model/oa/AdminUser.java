...
public class AdminUser extends OAObject {
    ...
    */
    ...
    public boolean getIsLLADCommandsAvailable() {
        ...
        RemoteClient rc = null;//RemoteClientDelegate.getRemoteClient(RemoteClient.TYPE_LLAD);
    ...
    public boolean getIsRCAvailable() {
        ...
        RemoteClient rc = null;//RemoteClientDelegate.getRemoteClient(RemoteClient.TYPE_RC);
        if (rc == null) return false;
        return (rc.getStatus() == rc.STATUS_Connected);
    }
