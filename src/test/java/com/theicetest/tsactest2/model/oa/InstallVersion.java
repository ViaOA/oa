...
@OATable(
    indexes = {
        @OAIndex(name = "InstallVersionApplication", columns = { @OAIndexColumn(name = "ApplicationId") })
    }
)
public class InstallVersion extends OAObject {
    ...
    @OAOne(
        reverseName = Application.P_InstallVersions, 
        required = true, 
    ...
    @OAOne(
        ...
        reverseName = PackageType.P_InstallVersions, 
        required = true, 
        allowCreateNew = false
    )
    ...
    @OAOne(
        ...
        reverseName = PackageVersion.P_InstallVersions
    )
