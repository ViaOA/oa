...
package com.theicetest.tsactest.model;
...
public class Model {
    ...
    private Hub<ServerStatus> hubServerStatuses;
    private Hub<ServerType> hubServerTypes;
