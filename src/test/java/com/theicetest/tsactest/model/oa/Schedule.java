...
import com.theicetest.tsactest.model.oa.filter.*;
...
public class Schedule extends OAObject {
    ...
    @OACalculatedProperty(displayName = "Real Start Time", displayLength = 8, properties = {P_StartTime, P_MRADClient+"."+MRADClient.P_Server+"."+Server.P_Silo+"."+Silo.P_Environment+"."+Environment.P_Site+"."+Site.P_Timezone, P_ServerGroup+"."+ServerGroup.P_MRADClients+"."+MRADClient.P_Server+"."+Server.P_Silo+"."+Silo.P_Environment+"."+Environment.P_Site+"."+Site.P_Timezone})
    ...
    @OACalculatedProperty(displayName = "Real Stop Time", displayLength = 8, properties = {P_StopTime, P_MRADClient+"."+MRADClient.P_Server+"."+Server.P_Silo+"."+Silo.P_Environment+"."+Environment.P_Site+"."+Site.P_Timezone, P_MRADClient, P_ServerGroup+"."+ServerGroup.P_MRADClients+"."+MRADClient.P_Server+"."+Server.P_Silo+"."+Silo.P_Environment+"."+Environment.P_Site+"."+Site.P_Timezone})
    ...
    @OACalculatedProperty(displayName = "Is For Today", displayLength = 5, properties = {P_Sunday, P_Monday, P_Tuesday, P_Wednesday, P_Thursday, P_Friday, P_Saturday, P_MRADClient+"."+MRADClient.P_Server+"."+Server.P_Silo+"."+Silo.P_Environment+"."+Environment.P_Site+"."+Site.P_Timezone, P_MRADClient+"."+MRADClient.P_ServerGroup+"."+ServerGroup.P_MRADClients+"."+MRADClient.P_Server+"."+Server.P_Silo+"."+Silo.P_Environment+"."+Environment.P_Site+"."+Site.P_Timezone})
    ...
    @OAOne(
        reverseName = MRADClient.P_Schedules, 
    ...
    @OAOne(
        ...
        reverseName = ServerGroup.P_Schedules, 
        allowCreateNew = false
    )
