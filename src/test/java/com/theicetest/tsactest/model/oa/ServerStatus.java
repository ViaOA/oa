...
public class ServerStatus extends OAObject {
    ...
    public Color getColor() {
        if (color == null) {
            switch (getType()) {
            case ServerStatus.TYPE_CONNECTING: color = Color.orange; break;
            case ServerStatus.TYPE_CONNECTED: color = Color.yellow; break;
            case ServerStatus.TYPE_RUNNING: 
                color = Color.green; break;
    
            case ServerStatus.TYPE_REQUESTCONNECT: 
            case ServerStatus.TYPE_REQUESTPAUSE: 
            case ServerStatus.TYPE_REQUESTRESUME: 
            case ServerStatus.TYPE_REQUESTSTOP: 
    ...
    @OAMany(
        ...
        reverseName = GSMRClient.P_ServerStatus, 
    ...
    @OAMany(
        ...
        reverseName = Server.P_ServerStatus, 
        createMethod = false
    )
    ...
    public void load(ResultSet rs, int id) throws SQLException {
        ...
        if (rs.wasNull()) {
            OAObjectInfoDelegate.setPrimitiveNull(this, ServerStatus.P_Type, true);
        }
