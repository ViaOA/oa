...
@OATable(
    indexes = {
        @OAIndex(name = "ProgramPageInfoProgram", columns = { @OAIndexColumn(name = "ProgramId") })
    }
)
public class ProgramPageInfo extends OAObject {
    ...
    @OAOne(
        ...
        reverseName = ImageStore.P_ProgramPageInfo, 
        cascadeSave = true, 
        cascadeDelete = true, 
    ...
    @OAOne(
        ...
        reverseName = PageInfo.P_ProgramPageInfos, 
        required = true, 
    ...
    @OAOne(
        reverseName = Program.P_ProgramPageInfos, 
        required = true, 
        allowCreateNew = false
    )
    ...
    @OAOne(
        ...
        reverseName = ProgramDocument.P_ProgramPageInfo, 
        cascadeSave = true, 
        cascadeDelete = true, 
        allowAddExisting = false
    )
