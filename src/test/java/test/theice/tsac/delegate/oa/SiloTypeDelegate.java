...
public class SiloTypeDelegate {
    ...
    public static SiloType getSiloType(test.theice.tsac.mrad.model.SiloType clientSiloType) {
        int type = SiloType.TYPE_ICE;
        if (clientSiloType != null) {
            if (clientSiloType == test.theice.tsac.mrad.model.SiloType.Endex) type = SiloType.TYPE_Endex;
            else if (clientSiloType == test.theice.tsac.mrad.model.SiloType.Liffe) type = SiloType.TYPE_Liffe;
        }
