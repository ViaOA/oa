package test.theice.tsac.delegate.oa;
...
import test.theice.tsac.model.oa.Application;
import test.theice.tsac.model.oa.ApplicationStatus;
import test.theice.tsac.model.oa.ApplicationType;
import test.theice.tsac.model.oa.Environment;
import test.theice.tsac.model.oa.MRADClient;
import test.theice.tsac.model.oa.MRADServer;
import test.theice.tsac.model.oa.OSVersion;
import test.theice.tsac.model.oa.OperatingSystem;
import test.theice.tsac.model.oa.Server;
import test.theice.tsac.model.oa.Silo;
import test.theice.tsac.model.oa.SiloType;
...
public class MRADClientDelegate {
    ...
    public static MRADClient getMRADClient(MRADServer mradServer, test.theice.tsac.mrad.model.Application clientApp) {
        try {
            lock.lock();
    ...
    private static MRADClient _getMRADClient(MRADServer mradServer, test.theice.tsac.mrad.model.Application clientApp) {
        ...
        test.theice.tsac.mrad.model.Server clientServer = clientApp.getServer();
        if (clientServer == null) return null;
        
        test.theice.tsac.mrad.model.ApplicationType clientAppType = clientApp.getApplicationType();
        if (clientAppType == null) return null;
        
        test.theice.tsac.mrad.model.SiloType clientSiloType = clientServer.getSiloType();
    ...
    public static boolean update(MRADClient mradClient, test.theice.tsac.mrad.model.Application clientApplication) {
        if (mradClient == null || clientApplication == null) return false;
        
        test.theice.tsac.mrad.model.Server clientServer = clientApplication.getServer();
        ...
        test.theice.tsac.mrad.model.ApplicationType clientApplicationType = clientApplication.getApplicationType();
        ...
        test.theice.tsac.mrad.model.ApplicationStatus clientAppStatus = clientApplication.getApplicationStatus();
