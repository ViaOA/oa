...
import test.theice.tsam.model.oa.propertypath.PPxInterface;
...
public class ApplicationTypePPx implements PPxInterface, Serializable {
    ...
    public ApplicationTypeCommandPPx applicationTypeCommands() {
        ApplicationTypeCommandPPx ppx = new ApplicationTypeCommandPPx(this, ApplicationType.P_ApplicationTypeCommands);
        return ppx;
    }

    public DeveloperPPx developers() {
        DeveloperPPx ppx = new DeveloperPPx(this, ApplicationType.P_Developers);
        return ppx;
    }

    public ApplicationGroupPPx excludeApplicationGroups() {
        ApplicationGroupPPx ppx = new ApplicationGroupPPx(this, ApplicationType.P_ExcludeApplicationGroups);
        return ppx;
    }

    public ApplicationGroupPPx includeApplicationGroups() {
        ApplicationGroupPPx ppx = new ApplicationGroupPPx(this, ApplicationType.P_IncludeApplicationGroups);
        return ppx;
    }
    ...
    public String defaultHostName() {
        return pp + "." + ApplicationType.P_DefaultHostName;
    }
    ...
    public String jarDirectoryName() {
        return pp + "." + ApplicationType.P_JarDirectoryName;
    }
