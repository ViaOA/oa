...
public class MRADClientPPx implements PPxInterface, Serializable {
    ...
    public HostInfoPPx hostInfo() {
        HostInfoPPx ppx = new HostInfoPPx(this, MRADClient.P_HostInfo);
        return ppx;
    }
    ...
    public String remoteSocketAddress() {
        return pp + "." + MRADClient.P_RemoteSocketAddress;
    }
    ...
    public String processId() {
        return pp + "." + MRADClient.P_ProcessId;
    }

    public String installedVersion() {
        return pp + "." + MRADClient.P_InstalledVersion;
    }

    public String dtInstall() {
        return pp + "." + MRADClient.P_DtInstall;
    }

    public String dtLastUpdated() {
        return pp + "." + MRADClient.P_DtLastUpdated;
    }

    public String lastConnectionId() {
        return pp + "." + MRADClient.P_LastConnectionId;
    }

    public String mradClientVersion() {
        return pp + "." + MRADClient.P_MRADClientVersion;
    }
    ...
    public String calcVersion() {
        return pp + "." + MRADClient.P_CalcVersion;
    }

    public String isConnected() {
        return pp + "." + MRADClient.P_IsConnected;
    }
