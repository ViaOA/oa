...
import test.theice.tsam.model.oa.ApplicationGroup;
...
import test.theice.tsam.model.oa.SiloConfig;
...
public class ApplicationType extends OAObject {
    ...
    @OAProperty(maxLength = 32, isUnique = true, isImportMatch = true, displayLength = 5, columnLength = 7)
    ...
    */
    ...
    @OAMany(
        ...
        owner = true, 
        reverseName = ApplicationTypeCommand.P_ApplicationType, 
        cascadeSave = true, 
        cascadeDelete = true, 
        matchProperty = ApplicationTypeCommand.P_Command
    )
    public Hub<ApplicationTypeCommand> getApplicationTypeCommands() {
        if (hubApplicationTypeCommands == null) {
            Hub<Command> hubMatch = test.theice.tsam.delegate.ModelDelegate.getCommands();
    ...
    @OAMany(
        toClass = Developer.class, 
        reverseName = Developer.P_ApplicationTypes
    )
    ...
    @OAMany(
        ...
        reverseName = ApplicationGroup.P_ExcludeApplicationTypes, 
        createMethod = false
    )
    @OALinkTable(name = "ApplicationGroupExcludeApplicationType", indexName = "ApplicationGroupExcludeApplicationType", columns = {"ApplicationTypeId"})
    ...
    @OAMany(
        ...
        toClass = ApplicationGroup.class, 
        reverseName = ApplicationGroup.P_IncludeApplicationTypes, 
        createMethod = false
    )
    @OALinkTable(name = "ApplicationGroupIncludeApplicationType", indexName = "ApplicationGroupIncludeApplicationType", columns = {"ApplicationTypeId"})
