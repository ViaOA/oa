...
public class IDL extends OAObject {
    ...
    private static Logger LOG = Logger.getLogger(IDL.class.getName());
    ...
    @OAProperty(defaultValue = "new OADateTime()", displayLength = 12, columnLength = 11, isProcessed = true)
    ...
    @OAProperty(maxLength = 25, displayLength = 10, columnLength = 9)
