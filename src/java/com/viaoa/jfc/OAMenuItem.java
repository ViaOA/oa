...
public class OAMenuItem extends JMenuItem implements OAJFCComponent{
    ...
    */
    ...
    /**
        Create a new OAButton that is bound to a Hub and command.
    */
    public OAMenuItem(Hub hub, int command, Icon icon) {
    ...
    */
    public OAMenuItem(Hub hub, int command, String text, Icon icon) {
        control = new OAMenuItemController(hub, command);
    ...
    */
    ...
    /**
     * This is a callback method that can be overwritten to determine if input is valid.
    ...
    class OAMenuItemController extends ButtonController {
        public OAMenuItemController(Hub hub, int command) {
            super(hub, OAMenuItem.this, command);
        }
        @Override
        protected boolean isEnabled(boolean bIsCurrentlyEnabled) {
