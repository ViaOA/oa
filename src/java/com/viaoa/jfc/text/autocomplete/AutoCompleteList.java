...
/**
 * Autocomplete that uses a JList for the popup component.
 * This is used by OATextFieldAutoCompletList.java
 * 
...
public abstract class AutoCompleteList extends AutoCompleteBase {
     ...
     * @param text value of textField
     * @param offset caret position of textfield
     * @return
     */
    ...
    /**
     * This can be used to auto-fill the remainder of value.  Example: if user enters 'abc' and there is a match 
     * for 'abcdef', the 'def' can also be filled in.
     * Returning value should be the least that is done. 
     */
    protected abstract String getClosestMatch(String value);  // from super class
    
    /*
     * This can be overwritten to replace the call to textfield.setText(value) when
     * the item is selected in the jlist
     */
     ...
     * Called when an item from Jlist is [clicked], [enter] on, or textField [enter] and there is only one item in Jlist.
     * @param pos in searchData
     * @param value value returned from searchData
     */
