...
/**
 * Uses a PrintPreviewController and PrinterJob to display and print Printable objects.
 * Printable, PageSetup and title are needed.
 * 
 * Has actionListeners to control commands for Print, Preview, PageFormat, etc.
 * 
 * @see #setPrintable(String, Printable, PageFormat)
 */
public class PrintController {
    ...
    public void print(boolean bUseDialog) {
        ...
        if (p == null) return;
        Thread t = new PrintThread(this.title, printerJob, p, bUseDialog, getPageFormat());
    ...
    static class PrintThread extends Thread {
        ...
        public PrintThread(String title, PrinterJob pj, Printable p, boolean bShowDialog, PageFormat pf) {
            this.title = title;
            printerJob = pj;
            printable = p;
...
java.lang.NullPointerException
    ...
    at sun.print.RasterPrinterJob.print(Unknown Source)
    at com.viaoa.jfc.print.PrintController$PrintThread.run(PrintController.java:251)
*/
                    pj.print();
