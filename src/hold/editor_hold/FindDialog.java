...
class FindDialog extends JDialog {
	...
	public FindDialog(JFrame frm, JTextPane ed) {
	...
	public void setSelectedIndex(int index) {
		m_tb.setSelectedIndex(index);
		setVisible(true);
		if (index == 0) m_txtFind1.requestFocus();
        else m_txtFind2.requestFocus();
		m_searchIndex = -1;
	}

	public int findNext(boolean doReplace, boolean showWarnings) {
		JTextPane monitor = editor;
