...
/** 
    ...
    @see OADateComboBox
*/
public class Hub2DateChooser extends Hub2Gui implements PropertyChangeListener {
    OADateChooser dateChooser;
    String prevValue;

    public Hub2DateChooser(Hub hub, OADateChooser dc, String propertyPath) {
    ...
    */
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        if (obj != null) {
            ...
            OAUndoManager.add(OAUndoableEdit.createUndoablePropertyChange(undoDescription,obj, getPropertyName(), prev, dateChooser.getDate()));
