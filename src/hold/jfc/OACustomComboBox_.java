...
/** 
    Abstract Class used to build ComboBoxes with custom popup windows that are bound to 
    an object or Hub.
    <p>
    For more information about this package, see <a href="package-summary.html#package_description">documentation</a>.
    @see Hub2CustomComboBox
*/
public abstract class OACustomComboBox_ extends JComboBox implements OAJFCComponent, OATableComponent {
    Hub2CustomComboBox hcb;
    OATextField vtf;
    int columns;
    OATable table;
    String heading = "";
    ...
    */
    public OACustomComboBox(Hub hub, String propertyPath) {
        hcb = new Hub2CustomComboBox(hub,this,propertyPath);
    }
    ...
    */
    public OACustomComboBox(Object obj, String propertyPath) {
        hcb = new Hub2CustomComboBox(obj,this,propertyPath);
    }
    ...
    */
    ...
    public void setSelectedItem(Object item) {
        ...
        try {
            ...
            if (hcb != null) hcb.updatePropertyValue(item);
    ...
    */
    public Component getTableRenderer(JLabel renderer, JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        if (h != null) {
            ...
            if (h == this.getHub()) {
	            String s = OAReflect.getPropertyValueAsString(obj, hcb.getGetMethods(), hcb.getFormat());
	            renderer.setText(s);
