...
public class VersionStatus extends OAObject {
    ...
    public void setLocked(boolean newValue) {
        ...
        firePropertyChange(PROPERTY_Locked, old, this.locked);
    }
    ...
    static {
        ...
        oaObjectInfo.addLink(new OALinkInfo(PROPERTY_Versions, Version.class, OALinkInfo.MANY, false, false, Version.PROPERTY_VersionStatus));
