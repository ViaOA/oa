...
public class Lab extends OAObject {
    ...
    static {
        ...
        oaObjectInfo.addLink(new OALinkInfo(PROPERTY_LabTests, LabTest.class, OALinkInfo.MANY, true, true, LabTest.PROPERTY_Lab, true));
